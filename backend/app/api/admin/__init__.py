...
router.include_router(
    advantages.router, prefix="/advantages", tags=["Admin Advantages"]
)
router.include_router(
    tech_stack.router, prefix="/tech-stack", tags=["Admin Tech Stack"]
)
router.include_router(
    work_stages.router, prefix="/work-stages", tags=["Admin Work Stages"]
)
